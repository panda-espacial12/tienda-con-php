          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-primary">
                ...
                <a href="visitor-mgmt.php" class="small-box-footer">Más Info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                  ...
                  <p>Apartamentos Ocupados</p>
                </div>
                <div class="icon">
                  <i class="ion ion-pie-graph"></i>
                </div>
                <a href="manage-apartment.php" class="small-box-footer">Más Info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
