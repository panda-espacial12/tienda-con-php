      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Visitantes Actuales</li>
          </ol>
        </section>
        <hr class="mb-0">
        <!-- Main content -->
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Lista de Visitantes Actuales</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    ?>
                      <tbody>
                        <tr>
                          ...
                          <td class='text-center'><a href="action-visitor.php?editid=<?php echo $row['ID']; ?>" title="Ver más información"><i class="fa fa-edit" style="color:green;"></i> Actualizar</a></td>
