...
if (strlen($_SESSION['avmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($query) {
      $msg = "Apartamento agregado, correctamente!";
    } else {
      $msg = "Algo salió mal";
    }
  }
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Agregar Información de Apartamento
            <!-- <small>Control panel</small> -->
          </h1>
          <ol class="breadcrumb">
            <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li class="active">Agregar Información de Apartamento</li>
          </ol>
        </section>
        <hr class="mb-0">
        ...
        <section class="content">
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Diligencia el formulario a continuación</h3>
            ...
            <div class="box-footer">
              <center><button type="submit" class="btn btn-primary rounded-0" name="submit">Agregar Apartamento</button></center>
            </div>
          </div>
          </form>
