      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Búsqueda de Visitante</li>
          </ol>
        </section>
              ...
              if (isset($_POST['search'])) {
                ...
                <div class="box">
                  <div class="box-header">
                    <h3 class="box-title">Mostrando registro solicitado según témino de búsqueda: "<?php echo $sdata; ?>"</h3>
                  </div>
                    ...
                    <table id="example1" class="table table-bordered table-hover table-striped">
                      <thead>
                        <tr>
                          ...
                          <th>Número de Contacto Visitante</th>
                          <th>Género</th>
                          <th>Sección</th>
                      ...
                      ?>
                        ...
                        <tr>
                          <td colspan="8">Sin registros encontrados!</td>
                        </tr>
