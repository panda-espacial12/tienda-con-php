...
<head>
  ...
  <title>Sistema Gestor de Servicio</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Reporte de Visitas</li>
        </ol>
      </section>
      <hr class="mb-0">
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Elige un rango de fechas</h3>
          ...
          <div class="box-body">
            ...
            <div class="box-footer">
              <center><button type="submit" class="btn rounded-0 btn-primary btn-lg" name="submit">Generar</button></center>
            </div>
