            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Visualización del informe de visitante solicitado a partir de <b><i><?php echo $fdate ?> to <?php echo $tdate ?></i></b> </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  <div class="text-right">
                    <button class="btn btn-success btn-sm rounded-0" type="button" id="print"><i class="fa fa-print"></i> Imprimir Reporte</button>
                  </div>
                  <br>
      ...
      <noscript id="print-header">
        <div>
          <div style="line-height:1em">
            <h2 class="mb-0 text-center">Reporte de Visitantes</h2>
