      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Gestionar Perfil</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Actualiza la información de tu perfil en el formulario</h3>
            ...
            ?>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-block btn-warning btn-sm" name="update">Enviar</button>
              </div>
          </div>
          </form>
