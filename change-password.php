...
if (strlen($_SESSION['avmsaid'] == 0)) {
  ...
  if (isset($_POST['update'])) {
    ...
    if ($row > 0) {
      ...
      $msg = "El password actual no es el correcto";
    }
  }
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Sección Contraseña</li>
          </ol>
        </section>
          ...
          ?>
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title">Actualiza la información a continuación</h3>
                  ...
                  <form method="POST" class="">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>Fecha de Registro de Cuenta</label>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-block btn-warning rounded-0" name="update">Enviar</button>
              </div>
            </div>
            </form>
