      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Registro de todos los Visitantes</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Resgistro de todos los Visitantes</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    ?>
                      <tbody>
                        <tr>
                          ...
                          <td><a href="action-visitor.php?editid=<?php echo $row['ID']; ?>" title="View Full Details"><i class="fa fa-eye" style="color:green;"></i> Ver</a></td>
