...
if (strlen($_SESSION['avmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($query) {
      $msg = "Observaciones de visita, se han registrado con exito";
    } else {
      $msg = "Algo salio mal, reinténtalo nuevamente!!";
    }
  }
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Información del Visitante</li>
          </ol>
        </section>
        <hr class="mb-0">
        <!-- Main content -->
        <section class="content">
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Diligencia las observaciones al final con la salida del Visitante</h3>
              ...
              <div class="box-body">
                <div class="container-fluid">
                  ...
                  <?php if ($row['remark'] == "") { ?>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Observaciones (solo al irse)</label>
                    ...
                    <div class="box-footer">
                      <center><button type="submit" class="btn btn-lg rounded-0 btn-warning" name="submit">Registrar Salida</button></center>
                    </div>
                  <?php } else { ?>
