...
<header class="main-header">
  ...
  <a href="dashboard.php" class="logo">
    ...
    <span class="logo-lg"><b>ConfiguroWeb</b></span>
  </a>
          ...
          <form action="search-result.php" method="POST">
            <div class="form-group" style="margin:0 !important; margin-top:.5em !important">
              <div class="input-group" style="max-width:25em">
                <input type="search" name="searchdata" id="searchdata" value="<?= isset($_POST['searchdata']) ? $_POST['searchdata'] : '' ?>" placeholder="Busca un visitante desde aquí" class="form-control rounded-0">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              ...
              <div class="pull-left">
                ...
                <a href="change-password.php" class="btn btn-default btn-flat">Cambiar Contraseña</a>
              </div>
